...
if [ "$1" -ge 1 ]; then # (upon update)
    ...
    %{_rpmconfigdir_os2}/wpi4rpm del %{vendor}/%{name}XXX/Library %{version}-%{release}
fi
...
%{_rpmconfigdir_os2}/wpi4rpm add %{vendor}/%{name}XXX/Library %{version}-%{release}
...
%changelog
* Wed Jun 06 2018 hb <herwig.bauernfeind@bitwiseworks.com> 0.1.7-3
- fix the location for wpi4rpm
